...
% ********                       Descripción:                      ********
% Analisis del diseño 8 con 180º de desfase y 20 mm de Gap 
...
data=readtable('T8_RZ_180y20.csv');
...
figure;
%
title('Comparación RZ, XY, 3D y Matlab', 'Modelo 8, Desfase: 180º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
