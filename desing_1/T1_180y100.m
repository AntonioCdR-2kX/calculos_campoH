...
% ********                       Descripción:                      ********
% Analisis del diseño 1 con 180º de desfase y 100 mm de Gap 
...
figure;
title('Comparación de la simulación en 3D y Matlab, con múltiples iteraciones', 'Modelo 1, Desfase: 180º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
plot(x_3D180y100,H_3D180y100,'k','DisplayName','H_3_D');
[x3D_Zoom,H3D_Zoom,n_Zoom]=Zoom(x_3D180y100,H_3D180y100,xMin,xMax,nPasos);


%% Representación en gráfica ampliada y el error relativo

figure;
title('Ampliación en el entorno de los conductores', 'Modelo 1, Desfase: 180º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
