...
% ********                       Descripción:                      ********
% Analisis del diseño 14 con 180º de desfase y 100 mm de Gap 
...
data=readtable('T14_RZ_180y100.csv');
...
sgtitle('Modelo 14, Desfase: 180º, Gap: 100mm');

% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 14, Desfase: 180º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
