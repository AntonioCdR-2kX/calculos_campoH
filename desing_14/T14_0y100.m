...
% ********                       Descripción:                      ********
% Analisis del diseño 14 con 0º de desfase y 100 mm de Gap 
...
data=readtable('T14_RZ_0y100.csv');
%Renombramos las variables que exportamos de Ansys
H_RZ0y100 = data.Mag_H_kA_per_m__Freq__1MHz_Phase__0deg_;
x_RZ0y100 = data.Distance_mm_;

% Obtengo la simulación en el eje X y Y
data=readtable('T14_XY_0y100.csv');
%Renombramos las variables que exportamos de Ansys
H_XY0y100 = data.Mag_H_kA_per_m__Freq__1MHz_Phase__0deg_;
x_XY0y100 = data.Distance_mm_-180;

% Falta la simulación en 3D
data=readtable('T14_3D_0y100.csv');
%Renombramos las variables que exportamos de Ansys
H_3D0y100 = data.Mag_H_kA_per_meter__Freq__1MHz_Phase__0deg_;
x_3D0y100 = data.Distance_mm_-180;
...
%
plot(x_RZ0y100,H_RZ0y100,'r-.','DisplayName','H_R_Z');
plot(x_XY0y100,H_XY0y100,'b-.','DisplayName','H_X_Y');
plot(x_3D0y100,H_3D0y100,'c-.','DisplayName','H_3_D');
...
sgtitle('Modelo 14, Desfase: 0º, Gap: 100mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 14, Desfase: 0º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
