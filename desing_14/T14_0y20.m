...
% ********                       Descripción:                      ********
% Analisis del diseño 14 con 0º de desfase y 20 mm de Gap 
...
data=readtable('T14_RZ_0y20.csv');
...
data=readtable('T14_XY_0y20.csv');
%Renombramos las variables que exportamos de Ansys
...
% 3D
subplot(2,2,3);
title('Comparación RZ, XY, 3D y Matlab, con el número optimo de iteraciones en 3D: 9');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
sgtitle('Modelo 14, Desfase: 0º, Gap: 20mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 14, Desfase: 0º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
