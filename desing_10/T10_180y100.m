...
% ********                       Descripción:                      ********
% Analisis del diseño 10 con 180º de desfase y 100 mm de Gap 
...
I2=-[100 100 100 100 100 100]; % Cambio el signo por el desfase
I=[I1',I2'];
...
data=readtable('T10_RZ_180y100.csv');
%Renombramos las variables que exportamos de Ansys
H_RZ180y100 = data.Mag_H_kA_per_m__Freq__1MHz_Phase__0deg_;
x_RZ180y100 = data.Distance_mm_;

% Obtengo la simulación en el eje X y Y
data=readtable('T10_XY_180y100.csv');
%Renombramos las variables que exportamos de Ansys
H_XY180y100 = data.Mag_H_kA_per_m__Freq__1MHz_Phase__0deg_;
x_XY180y100 = data.Distance_mm_-150;

% Falta la simulación en 3D
data=readtable('T10_3D_180y100.csv');
%Renombramos las variables que exportamos de Ansys
H_3D180y100 = data.Mag_H_kA_per_meter__Freq__1MHz_Phase__0deg_;
x_3D180y100 = data.Distance_mm_-150;
...
%
plot(x_RZ180y100,H_RZ180y100,'r-.','DisplayName','H_R_Z');
plot(x_XY180y100,H_XY180y100,'b-.','DisplayName','H_X_Y');
plot(x_3D180y100,H_3D180y100,'c-.','DisplayName','H_3_D');
...
sgtitle('Modelo 10, Desfase: 180º, Gap: 100mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 10, Desfase: 180º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
