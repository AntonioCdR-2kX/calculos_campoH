...
% ********                       Descripción:                      ********
% Analisis del diseño 10 con 180º de desfase y 20 mm de Gap 
...
data=readtable('T10_RZ_180y20.csv');
...
data=readtable('T10_XY_180y20.csv');
%Renombramos las variables que exportamos de Ansys
H_XY180y20 = data.Mag_H_kA_per_m__Freq__1MHz_Phase__0deg_;
x_XY180y20 = data.Distance_mm_-150;
...
sgtitle('Modelo 10, Desfase: 180º, Gap: 20mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 10, Desfase: 180º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
