...
% ********                       Descripción:                      ********
% Analisis del diseño 4 con 0º de desfase y 50 mm de Gap 
...
x_3D0y50 = data.Distance_mm_-(285/2);
...
figure;
title('Comparación de la simulación en 3D y Matlab, con múltiples iteraciones', 'Modelo 4, Desfase: 0º, Gap: 50mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
plot(x_3D0y50,H_3D0y50,'k','DisplayName','H_3_D');
[x3D_Zoom,H3D_Zoom,n_Zoom]=Zoom(x_3D0y50,H_3D0y50,xMin,xMax,nPasos);


%% Representación en gráfica ampliada y el error relativo

figure;
title('Ampliación en el entorno de los conductores', 'Modelo 4, Desfase: 0º, Gap: 50mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
