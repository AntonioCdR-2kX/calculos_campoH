...
% ********                       Descripción:                      ********
% Analisis del diseño 11 con 0º de desfase y 20 mm de Gap 
...
data=readtable('T11_RZ_0y20.csv');
...
% RZ
subplot(2,2,1);
title('Comparación RZ, XY, 3D y Matlab, con el número optimo de iteraciones en RZ: 14');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
% 3D
subplot(2,2,3);
title('Comparación RZ, XY, 3D y Matlab, con el número optimo de iteraciones en 3D: 10');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
sgtitle('Modelo 11, Desfase: 0º, Gap: 20mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 11, Desfase: 0º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
