...
% ********                       Descripción:                      ********
% Analisis del diseño 2 con 0º de desfase y 20 mm de Gap 
...
figure;
title('Comparación de la simulación en 3D y Matlab, con múltiples iteraciones', 'Modelo 2, Desfase: 0º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
figure;
title('Ampliación en el entorno de los conductores', 'Modelo 2, Desfase: 0º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
