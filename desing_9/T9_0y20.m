...
% ********                       Descripción:                      ********
% Analisis del diseño 9 con 0º de desfase y 20 mm de Gap 
...
figure;
%
title('Comparación RZ, XY, 3D y Matlab', 'Modelo 9, Desfase: 0º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
