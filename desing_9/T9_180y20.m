...
% ********                       Descripción:                      ********
% Analisis del diseño 9 con 180º de desfase y 20 mm de Gap 
...
data=readtable('T9_RZ_180y20.csv');
...
figure;
%
title('Comparación RZ, XY, 3D y Matlab', 'Modelo 9, Desfase: 180º, Gap: 20mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
% No tiene sentido emplear varías iteraciones, por no tener nucleos
