...
% ********                       Descripción:                      ********
% Analisis del diseño 5 con 0º de desfase y 100 mm de Gap 
...
figure;
title('Comparación de la simulación en 3D y Matlab, con múltiples iteraciones', 'Modelo 5, Desfase: 0º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
...
figure;
title('Ampliación en el entorno de los conductores', 'Modelo 5, Desfase: 0º, Gap: 100mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
