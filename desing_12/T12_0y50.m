...
% ********                       Descripción:                      ********
% Analisis del diseño 12 con 0º de desfase y 50 mm de Gap 
...
data=readtable('T12_RZ_0y50.csv');
...
sgtitle('Modelo 12, Desfase: 0º, Gap: 50mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 12, Desfase: 0º, Gap: 50mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
