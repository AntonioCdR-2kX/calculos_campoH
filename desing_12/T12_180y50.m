...
% ********                       Descripción:                      ********
% Analisis del diseño 12 con 180º de desfase y 50 mm de Gap 
...
data=readtable('T12_RZ_180y50.csv');
...
data=readtable('T12_XY_180y50.csv');
%Renombramos las variables que exportamos de Ansys
...
sgtitle('Modelo 12, Desfase: 180º, Gap: 50mm');


% Varias iteraciones
figure;
title('Comparación RZ, XY, 3D y Matlab con múltiple iteraciones', 'Modelo 12, Desfase: 180º, Gap: 50mm');
xlabel('x (mm)');
ylabel('H (A/mm)');
grid on;
hold on;
